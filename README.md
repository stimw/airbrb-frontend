![airbrb-image](image.png)

# Demo

https://airbrb.onrender.com/

# Backend

Github repo: [airbrb-beckend](https://github.com/stimw/airbrb-backend)

# Usage

In `frontend` folder, `yarn install` and `yarn start`.
